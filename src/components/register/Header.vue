    ...
    <div class="header">
        <div class="container">
            <div class="header__box">
                <img class="header__logo" src="../../assets/img/registerlogo.png" alt="logo">
                <div class="header__item">
                    <button class="header__item--button">SELL</button>
                    <router-link class="header__item--login" to="/login">LOGIN</router-link>
                    <svg class="header__logo" width="20" height="19" viewBox="0 0 20 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path class="header__logo--path" fill-rule="evenodd" clip-rule="evenodd" d="M14.468 0.0104926C15.968 0.0104926 17.3937 0.638009
